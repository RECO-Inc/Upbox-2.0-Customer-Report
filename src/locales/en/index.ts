export default {
  ...
  user: {
    ...
    disposal: 'Disposal',
    invalidBrowserToken: 'Invalid browser token.',
    invalidBrowserTokenParse: 'Error parsing browser token.',
    invalidCredentialParse: 'Error parsing saved account information.',
    loginFailed: 'Login failed.',
    manager: 'Manager',
    newAccessTokenSuccess: 'Token reissued. Token valid until {datetime}.',
    newRefreshTokenSuccess: 'Token reissued. Refresh token valid until {datetime}.',
    noAuthorityCompanyUuid: 'The business information is invalid. Please log in again.',
    noExistBrowserToken: 'No browser token found.',
